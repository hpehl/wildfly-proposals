...
The feature is intended to be introduced at the *Experimental* or *Preview* level.
////
...
* Support for server side interceptors and clients
...
Detailed description in wildfly-grpc-feature-pack/docs/guide/index.adoc
